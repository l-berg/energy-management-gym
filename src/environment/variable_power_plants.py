...
class LoadFollowingPowerPlant(PowerPlant):
    ...
    """
    def __init__(self, initial_output, max_capacity, output_increment, step_size, min_capacity, output_gradient,
                 price_per_mwh):
        ...
        self.max_output_gradient = output_gradient * max_capacity * step_size/60.0
    ...
    def more(self):
        self.target_output = min(self.current_output + self.output_increment * self.max_capacity, self.max_capacity)

    def less(self):
        self.target_output = max(self.current_output - self.output_increment * self.max_capacity, self.min_capacity)
...
class LignitePowerPlant(LoadFollowingPowerPlant):
    def __init__(self, initial_output, max_capacity, output_increment, step_size):
        super().__init__(initial_output, max_capacity, output_increment, step_size, 0.4 * max_capacity, 0.04, 0.78)
        

class HardCoalPowerPlant(LoadFollowingPowerPlant):
    def __init__(self, initial_output, max_capacity, output_increment, step_size):
        super().__init__(initial_output, max_capacity, output_increment, step_size, 0.4 * max_capacity, 0.03, 1.014)


class GasPowerPlant(LoadFollowingPowerPlant):
    """Based on GuD power plants"""
    def __init__(self, initial_output, max_capacity, output_increment, step_size):
        super().__init__(initial_output, max_capacity, output_increment, step_size, 0.2 * max_capacity, 0.06, 0.45)


class NuclearPowerPlant(LoadFollowingPowerPlant):
    def __init__(self, initial_output, max_capacity, output_increment, step_size):
        # TODO CO2 emissions for uranium mining
        super().__init__(initial_output, max_capacity, output_increment, step_size, 0.5 * max_capacity, 0.05, 0.0)


class BioMassPowerPlant(LoadFollowingPowerPlant):
    def __init__(self, initial_output, max_capacity, output_increment, step_size):
        # TODO CO2 emissions for producing biomass
        super().__init__(initial_output, max_capacity, output_increment, step_size, 0.2 * max_capacity, 0.2, 0.0)
